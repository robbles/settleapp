...
~~~sh
git clone git@github.com:nko3/i-dont-node.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-i-dont-node --password F+W2S2DFAqAhjHZH
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/i-dont-node" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280914
[3]: https://github.com/nko3/i-dont-node
